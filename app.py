...
class App:
        ...
        with open(self.filename, "r") as file:
            ...
            for row in reader:
                if row[0] == "Battery":
                    ...
                    self.components.append(LEDLight(*row[1:]))
                elif row[0] == "LightGlobe":
                    self.components.append(LightGlobe(*row[1:]))
    ...
    def circuit_kits_menu(self):
        while True:
            ...
            if choice == "1":
                print("Feature to create circuit kits is not implemented yet.")
            elif choice == "2":
                print("Feature to view circuit kits is not implemented yet.")
            elif choice == "3":
                break
            else:
                print("Wrong input, must be a number between 1 and 3.")
